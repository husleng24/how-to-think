...
pub const PRIMARY_CLI_COMMANDS: &[(&str, &str)] = &[
    ("help", "help"),
    ("version", "version"),
    ...
    ("workspace.recent.list", "workspace.recent.list"),
    ("workspace.files.list", "workspace.files.list"),
    ("workspace.files.refresh", "workspace.files.refresh"),
    ("workspace.file.create", "workspace.file.create"),
    ("workspace.file.open", "workspace.file.open"),
    ("workspace.file.save", "workspace.file.save"),
    ("workspace.file.rename", "workspace.file.rename"),
    ("workspace.file.delete", "workspace.file.delete"),
    ("markdown.parse", "markdown.parse"),
    ("markdown.check", "markdown.check"),
    ("markdown.serialize", "markdown.serialize"),
    ("markdown.links.resolve", "markdown.links.resolve"),
    ("mindmap.read", "mindmap.read"),
    ("mindmap.create", "mindmap.create"),
    ("mindmap.node.add", "mindmap.node.add"),
    ("mindmap.node.update", "mindmap.node.update"),
    ("mindmap.branch.move", "mindmap.branch.move"),
    ("mindmap.branch.delete", "mindmap.branch.delete"),
    ("mindmap.siblings.reorder", "mindmap.siblings.reorder"),
    ("mindmap.collapse", "mindmap.collapse"),
    ("mindmap.expand", "mindmap.expand"),
    ("mindmap.focus-node", "mindmap.focus-node"),
    ("mindmap.fit-view", "mindmap.fit-view"),
    ("mindmap.drag-layout", "mindmap.drag-layout"),
    ("mindmap.history.undo", "mindmap.history.undo"),
    ("mindmap.history.redo", "mindmap.history.redo"),
    ("render", "render"),
    ("git.detect", "git.detect"),
    ("git.init", "git.init"),
    ...
    ("ai.provider.list", "ai.provider.list"),
    ("ai.provider.health", "ai.provider.health"),
    ("ai.context.preview", "ai.context.preview"),
    ("ai.chat.send", "ai.chat.send"),
    ("ai.proposal.validate", "ai.proposal.validate"),
    ("ai.proposal.apply", "ai.proposal.apply"),
    ("ui.open", "ui.open"),
    ("ui.focus", "ui.focus"),
    ("ui.review", "ui.review"),
];
