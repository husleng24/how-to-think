...
import {
  AiContextPreview,
  emptyAiContextPreviewState,
} from '../../ai';
import type { AiContextPreviewState } from '../../ai';
import {
...
export function AiAssistantPanel({
  ...
  const [previewState, setPreviewState] = useState<AiContextPreviewState>(emptyAiContextPreviewState);
  ...
  useEffect(() => {
    if (!open || !workspaceId) {
      setPreviewState(emptyAiContextPreviewState);
      return undefined;
    }
  ...
  return (
    <aside className="ai-assistant-drawer" aria-label="AI assistant">
      ...
      <AiContextPreview previewState={previewState} />
